...
scoreboard players add @e[type=ha:death_train,scores={dia=!40}] dia 1

execute @e[type=ha:death_train,scores={dia=!40}] ~ ~ ~ tellraw @a {"rawtext": [{"text":"§aUn Administrador cambio el dia, al Dia "},{"score": {"name":"@s","objective":"dia"}},{"text":"."}]}
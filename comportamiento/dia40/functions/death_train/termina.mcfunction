...
scoreboard players reset @e[type=ha:death_train] dh
scoreboard players reset @e[type=ha:death_train] dm
scoreboard players reset @e[type=ha:death_train] ds
scoreboard players reset @e[type=ha:death_train] dhs
scoreboard players reset @e[type=ha:death_train] dms
scoreboard players reset @e[type=ha:death_train] dss

tag @e[type=ha:death_train] remove activate_rain
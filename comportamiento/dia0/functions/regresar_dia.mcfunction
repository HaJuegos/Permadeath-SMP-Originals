...
scoreboard players remove @e[type=ha:death_train,scores={dia=!-1}] dia 1

execute @e[type=ha:death_train,scores={dia=!-1}] ~ ~ ~ tellraw @a {"rawtext": [{"text":"§aUn Administrador cambio el dia, al Dia "},{"score": {"name":"@s","objective":"dia"}},{"text":"."}]}